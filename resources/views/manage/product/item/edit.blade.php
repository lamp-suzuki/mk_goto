    ...
    <div id="postPublic-date" class="form-date">
      ...
      <div class="d-flex justify-content-start align-items-center flex-wrap">
        <div class="form-inline">
          <input type="date" name="release_start" value="{{ date('Y-m-d', strtotime($menu->release_start)) }}" class="form-control w-auto mr-2" id="release_start" />
        </div>
        <span class="mx-2">〜</span>
        <div class="form-inline">
          <input type="date" name="release_end" value="{{ date('Y-m-d', strtotime($menu->release_end)) }}" class="form-control w-auto mr-2" id="release_end" />
        </div>
      </div>
    </div>
  </div>
